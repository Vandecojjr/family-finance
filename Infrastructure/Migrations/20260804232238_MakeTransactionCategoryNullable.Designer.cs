...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260804232238_MakeTransactionCategoryNullable")]
    partial class MakeTransactionCategoryNullable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.CreidtCards.CreditCardInvoice", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Domain.Entities.Incomes.IncomePayment", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("IncomePayments", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Entities.CreidtCards.CreditCardInvoice", b =>
                {
                    b.HasOne("Domain.Entities.CreidtCards.CreditCard", "CreditCard")
                        .WithMany("Invoices")
            ...
            modelBuilder.Entity("Domain.Entities.Incomes.IncomePayment", b =>
                {
                    b.HasOne("Domain.Entities.Incomes.Income", null)
                        .WithMany("Payments")
                        .HasForeignKey("IncomeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
