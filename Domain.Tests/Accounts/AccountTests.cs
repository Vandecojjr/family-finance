...
public class AccountTests
{
    ...
    {
        var acc = new Account("u@mail.com", "hash", Guid.NewGuid());
    ...
    {
        var initialMemberId = Guid.NewGuid();
        var acc = new Account("u@mail.com", "hash", initialMemberId);
        
        Assert.Equal(initialMemberId, acc.MemberId);
