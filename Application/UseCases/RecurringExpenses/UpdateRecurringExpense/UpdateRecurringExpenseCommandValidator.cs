...
public sealed class UpdateRecurringExpenseCommandValidator : AbstractValidator<UpdateRecurringExpenseCommand>
{
    public UpdateRecurringExpenseCommandValidator()
    {
        RuleFor(x => x.Id)
