...
public sealed class DeactivateRecurringExpenseCommandHandler(
    IRecurringExpenseRepository recurringExpenseRepository,
    IFamilyRepository familyRepository,
    ICurrentUser currentUser) : ICommandHandler<DeactivateRecurringExpenseCommand, Result>
{
    public async ValueTask<Result> Handle(
        DeactivateRecurringExpenseCommand command,
        CancellationToken cancellationToken)
    {
        ...
        {
            return Result.Failure(
                Error.Failure("Family.AccessDenied", "Você não tem permissão para desativar este gasto recorrente."));
        }
