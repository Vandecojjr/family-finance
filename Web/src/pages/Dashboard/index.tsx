            ...
            <div style={{
                ...
                <aside style={{
                    ...
                    <div style={{ padding: '0 2rem', marginBottom: '3rem' }}>
                        <span style={{ fontSize: '1.25rem', fontWeight: 700, letterSpacing: '-0.025em' }}>Dashboard</span>
                    </div>

                    <nav style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem', flex: 1 }}>
                        <SidebarItem icon={<Home size={20} />} label="Dashboard" active />
                        <SidebarItem icon={<TrendingUp size={20} />} label="Empoudo" />
                        <SidebarItem icon={<TrendingDown size={20} />} label="Expondo" />
                    </nav>
                ...
                {/* Main Content */}
                <main style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: '2rem', minWidth: 0 }}>
